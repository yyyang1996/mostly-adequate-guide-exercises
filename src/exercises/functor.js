...
import Identity from '../functors/Identity'
import Maybe from '../functors/Maybe'
import { Left, Right } from '../functors/Either'
import { fmap, either } from '../functors/utils'
...
var ex1 = curry((num, functor) => {
  return fmap(_.map(_.add(num)), functor)
})
...
var ex3 = _.compose(fmap(_.head), safeProp('name'))(user)
...
var ex4 = _.compose(fmap(parseInt), Maybe.of)
...
var ex5 = _.compose(fmap(_.toUpperCase), getPost)
